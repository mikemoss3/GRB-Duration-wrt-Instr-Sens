...
template_grb = GRB()
# Make light curve 
template_grb.load_light_curve("data-files/sw00821881000b_1chan_1s.lc")
# template_grb.light_curve['TIME'] -= 448001706.176
template_grb.light_curve['TIME'] -= 544495556.416
...
# Where does this normalization come from? Cause 2000 is exactly correct. 
template_grb.spectrum['RATE'] /= 2000
template_grb.spectrum['UNC'] /= 2000
...
synth_t90, t_start, t_end, synth_t90_flue = bayesian_t_blocks(synth_grb)
