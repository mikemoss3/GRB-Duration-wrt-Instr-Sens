...
# Make a GRB object
template_grb = GRB(z=z,T100_start=-0.028,T100_dur=14.972)
# Make light curve 
template_grb.load_light_curve("data-files/template-light-curves/grb_160121A_1chan_1s.lc", rm_trigtime=True, det_area=0.16)
...
norm = template_grb.get_ave_photon_flux(tmin=0.5,tmax=11) / PL(alpha=-1.77,norm=1,enorm=1)._calc_phot_flux(15, 150) # for GRB GRB 081007
template_grb.load_specfunc(PL(alpha=-1.77,norm=norm,enorm=1))
